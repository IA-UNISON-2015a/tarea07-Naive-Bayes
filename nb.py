...
class NaiveBayes:
    ...
    def aprende(self, datos, clases):
        ...
        for clase in self.clases:
            # Guarda las veces que se repite "clase" en "clases"
            ...
            for (i, var) in enumerate(self.var_nom):
                ...
                for val in self.vals[var]:
                    # Guarda las veces que se repite el valor "val" para la clase "clase"
                    # en la columna "var" en datos
        ...
        N = sum([self.frec['clases'][clase] for clase in self.clases])
        for clase in clases:
    ...
    def reconoce(self, datos):
        ...
        return [max(self.clases, key=lambda clase: log_prob(dato, clase))
                  for dato in datos]
